        ...
        <section>
            <div className='md:flex justify-between items-center gap-10 my-10 mx-5 lg:mx-0'>
                <div className='bg-[#F0F5FF] p-6 rounded-2xl md:w-[50%] md:h-[680px]'>
                    ...
                    <button className='text-[18px] w-[410px ] bg-[#266CDF] md:px-16 p-2 rounded-lg mt-6 text-white'>Learn about Hashtag Tools</button>
                ...
                <div className='bg-[#F4F0FF] p-6 rounded-2xl mt-5 md:mt-0 md:w-[50%] md:h-[680px]'>
                    ...
                    <button className='text-[18px] w-[410px ] bg-[#8A3FF2] md:px-16 p-2 rounded-lg mt-6 text-white'>Learn about Scheduler</button>
            ...
            <div>
                <div className='md:flex justify-between items-center gap-10 my-10 mx-5 lg:mx-0'>
                    <div className='bg-[#FFF8F0] p-6 rounded-2xl md:w-[50%] md:h-[680px]'>
                        ...
                        <button className='text-[18px] w-[410px ] bg-[#ED9100] md:px-16 p-2 rounded-lg mt-6 text-white'>Learn about Analytics Tool</button>
                    ...
                    <div className='bg-[#FAFAFA] p-6 rounded-2xl mt-5 md:mt-0 md:w-[50%] md:h-[680px]'>
                        ...
                        <button className='text-[18px] w-[410px ] bg-black md:px-16 p-2 rounded-lg mt-6 text-white'>Visit Flick's Blog</button>
