...
const AiSocialAssistant = () => {
    return (
        <div className='mt-20 flex justify-between items-center bg-gradient-to-r from-[#ECE1FC] via-[#E6E7FB] to-[#F1F4F9] p-7 rounded-2xl'>
            <div>
                ...
                <button className='text-[18px] w-[410px ] bg-gradient-to-r from-[#240764] via-[#323999] to-[#2A62AB] px-28 p-2 rounded-lg mt-6 text-white'>Learn about Ai Assistant</button>
            </div>
            <div>
