...
const Banner = () => {
    return (
        <div className='pt-5 text-white relative'>
            ...
            <section className='grid justify-center items-center absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full'>
            ...
            <section className='flex jusftify-between items-center gap-[150px] mt-[350px] text-black max-w-[1280px] mx-auto'>
                ...
                <div className=''>
                <button className='text-[18px] w-[410px ] hover:bg-[#266CDF] px-28 p-2 rounded-lg mt-6 border shadow-xl'>Get Started for Free</button>
                <div className='text-[14px] mt-4 flex justify-center gap-10'>
                        <p>Center Anytime</p>
                        <p>Easy Setup</p>
                        <p>Support</p>
